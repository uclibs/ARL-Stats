...
string_agg(bibloc.location_code, ' ') AS Location
    ...
    JOIN sierra_view.bib_record_location bibloc ON (i.id = bibloc.bib_record_id AND i.bcode2 = 's') -- Bib format code here
    ...
    --AND i.record_num between '1715000' and '3000000'
    AND i.record_num <= '1715000'
