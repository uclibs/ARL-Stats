...
Question 1, microform format set 3
...
string_agg(bibloc.location_code, ' ') AS Location
    ...
    JOIN sierra_view.bib_record_location bibloc ON (i.id = bibloc.bib_record_id AND (i.bcode2 = 'h' OR i.bcode2 = 'v'))  -- Bib format here
